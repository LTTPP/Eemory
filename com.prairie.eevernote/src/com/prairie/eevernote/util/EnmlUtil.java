...
import com.prairie.eevernote.enml.StyleTextRange;
...
public class EnmlUtil implements Constants {
	...
	private static StyleTextRange[] parse(String text, StyleRange[] styleRanges, int offset) {
	...
	private static Div div(StyleTextRange[] textRanges, String face, String size) {
		Div div = new Div();
